        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/bookings", "/public/bookings", "/payments/razorpay/orders", "/payments/razorpay/verify", "/payments/razorpay/webhook")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/payments/health/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/payments/test/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/payments/debug/**")
                    .permitAll()
