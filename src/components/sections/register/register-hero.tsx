...
export default function RegisterHero({ event }: RegisterHeroProps) {
  return (
    <section className="relative isolate min-h-[56vh] overflow-hidden bg-black">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_20%,rgba(145,255,98,0.16),transparent_36%),radial-gradient(circle_at_78%_22%,rgba(173,216,255,0.1),transparent_34%)]" />
