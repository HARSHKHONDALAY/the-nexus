...
export default function ContactHero() {
  return (
    <section className="relative isolate min-h-[64vh] overflow-hidden bg-black">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(145,255,98,0.16),transparent_38%),radial-gradient(circle_at_74%_24%,rgba(173,216,255,0.1),transparent_34%)]" />
